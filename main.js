...
console.log(myRandom.toFixed(0));
...
var strObj = {str: 'Мама мыла раму, рама мыла маму', length: 'Мама мыла раму, рама мыла маму'.length};
console.log(strObj.str,'. Длина строки - ', strObj.str.length );
